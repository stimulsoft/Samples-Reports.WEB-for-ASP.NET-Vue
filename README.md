# ASP.NET and ASP.NET Core C# samples for Stimulsoft Reports.VUE

#### This repository contains source code examples demonstrating the usage of the Stimulsoft Reports.VUE reporting tool in ASP.NET Vue apps, using TypeScript and C# code, along with Vue embedded components. The report generator and components are fully compatible with .NET 6.0 and all later versions.

## Overview
This repository has a set of examples (Visual Studio projects), each in different folders:
* [Integrating the Report Viewer into an Application](https://github.com/stimulsoft/Samples-Reports.WEB-for-ASP.NET-Vue/tree/master/NET%208.0/Integrating%20the%20Report%20Viewer%20into%20an%20Application)
...
* [.NET 6.0](https://github.com/stimulsoft/Samples-Reports.WEB-for-ASP.NET-Vue/tree/master/NET%206.0)
* [.NET 8.0](https://github.com/stimulsoft/Samples-Reports.WEB-for-ASP.NET-Vue/tree/master/NET%208.0)
* [.NET 10.0](https://github.com/stimulsoft/Samples-Reports.WEB-for-ASP.NET-Vue/tree/master/NET%2010.0)
...
* [ASP.NET React](https://github.com/stimulsoft/Samples-Reports.WEB-for-ASP.NET-React)
...
Stimulsoft Reports.VUE is a cross-platform set of tools for report creating developed to be used in conjunction with the Vue framework. Our solution is compatible with Vue 3.4+ and later, and contains everything you need to create, edit, view and export reports. The server side of the product uses .NET Core platform.

## Useful links
* [Live Demo](http://demo.stimulsoft.com/#Net)
* [Product Page](https://www.stimulsoft.com/en/products/reports-vue)
* [Free Download](https://www.stimulsoft.com/en/downloads)
* [Documentation](https://www.stimulsoft.com/en/documentation/online/programming-manual/index.html)
* [License](LICENSE.md)
